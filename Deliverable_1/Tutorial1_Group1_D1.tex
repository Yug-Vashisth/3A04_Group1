...
\begin{itemize}
	...
	\item SCEMAS: Smart City Environmental Monitoring and Alert System 
    \item CESI: Canadian Environmental Sustainability Indicators
...
\begin{enumerate}[{\bf BE7.}]
	\item Request Access to Public API \#7
		\begin{enumerate}[{\bf VP1.}]
			\item City Operators \#1\\
