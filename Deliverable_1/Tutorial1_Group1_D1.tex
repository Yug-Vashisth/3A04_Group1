...
\begin{enumerate}[{UH-L}1. ]
	...
	\textbf{Rationale:} Operators must quickly understand the core interface to respond to environmental events effectively. Limiting the learning time ensures the system is intuitive and reduces onboarding effort. \textcolor{red}{https://www.sciencedirect.com/topics/computer-science/usability-attribute}
	...
	\textbf{Rationale:} Users should quickly learn how best to tailor the application to them. If they are able to personalize the system quickly it will make sure that the rest of their time using the system is more enjoyable. \textcolor{red}{https://insiderone.com/website-personalization/}
	...
	\textbf{Rationale:} City operators that are familiar with the system should be able to navigate the dashboard and acknowledge an alert, this shows the system is user-friendly and accessible. \textcolor{red}{https://www.forbes.com/councils/forbesagencycouncil/2020/04/07/designing-the-right-website-navigation/}
	...
	\textbf{Rationale:} Developers that are willing to subscribe to APIs should be able to understand the documentation in the short(1-hour) time frame. If they are able to understand the documentation within this time it means that the documentation is written clearly and helps improve usability of the service.\textcolor{red}{https://den.dev/blog/horrible-api-documentation/}
...
\begin{enumerate}[{PR-SC}1. ]
    ...
    \textbf{Rationale}: A rapid alert system allows operations to respond to any alerts within a timely manner, staging interventions or putting out city-wide alerts where possible.\textcolor{red}{[https://middleware.io/blog/real-time-alerts/]} 
\end{enumerate}
% End SubSubSection
...
\begin{enumerate}[{PR-RFT}1. ]
    ...
    \textbf{Rationale}: This is to ensure that all errors are properly logged as well as properly addressed within a timely manner \textcolor{red}{to help prevent system crashes and downtime.[https://fastercapital.com/content/Error-detection--Detecting-Errors--The-Key-Role-of-the-Error-Principle.html#Understanding-the-Importance-of-Error-Detection]}
\end{enumerate}
% End SubSubSection
...
\begin{enumerate}[{PR-L}1. ]
    ...
    \textbf{Rationale}: \textcolor{red}{Replacing a sensor can be costly and disruptive. It is important that each sensor preforms optimally for an extended period of time to avoid frequent replacements. Replacing a sensor can be costly and disruptive. [https://www.researchgate.net/publication/381630208_Advances_and_Challenges_in_IoT_Sensors_Data_Handling_and_Processing_in_Environmental_Monitoring_Networks#pf13]}
\end{enumerate}
% End SubSubSection
