...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item UML Class Diagram for reference:\\ https://github.com/Yug-Vashisth/3A04_Group1/blob/main/Deliverable_3/class-diagrams/class-diagram.svg
    \end{itemize}
    \vspace{0.5cm}
    \centering
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Reviewed the UML class diagram
        \item Assisted in modifying and providing feedback for further revisions
    \end{itemize}
