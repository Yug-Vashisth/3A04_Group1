...
\textbf{Assumptions About What the Software Is Aiming to Achieve}
    \begin{itemize}
        ...
        \item All IoT sensors have already been installed and require no additional setup.
        \item No PII data will be collected or transmitted by IoT sensors
    \end{itemize}
...
\begin{enumerate}[{\bf BE7.}]
    \item Request Access to Public API
        \begin{enumerate}[{\bf VP1.}]
            ...
            \item Public Users \\
                \textbf{Pre-condition}: User has a registered Public User SCEMAS account and is logged in.\\
                \textbf{Main Success Scenario}
                \begin{quote}
                    \begin{description}
            ...
            \item Administrators \\
                \textbf{Pre-condition}: User has a registered Administrator SCEMAS account and is logged in viewing admin dashboard.\\
                \textbf{Main Success Scenario}
                \begin{quote}
                    \begin{description}
            ...
            \item Third-Party Developers \\
                \textbf{Pre-condition}: User has a registered Third-Party Developer SCEMAS account and is logged in.\\
                \textbf{Main Success Scenario}
                \begin{quote}
                    \begin{enumerate}[1.]
            ...
            \item IT Support \\
    \textbf{Pre-condition}: User has a registered IT Support SCEMAS account and is logged in.\\
    \textbf{Main Success Scenario}
    \begin{quote}
        \begin{description}
...
\begin{enumerate}[{\bf BE8.}]
	\item Modify Account
		\begin{enumerate}[{\bf VP1.}]
			...
			\item Public Users \\
                \textbf{Pre-condition}: User has a valid Public User SCEMAS account and is logged in. \\
                \textbf{Main Success Scenario}
                \begin{quote}
                    \begin{enumerate}[1.]
			...
			\item Administrators \\
                \textbf{Pre-condition}: User has a valid Administrator SCEMAS account and is logged in. \\
                \textbf{Main Success Scenario}
                \begin{quote}
    \begin{description}
...
\end{quote}
			...
			\item Third-Party Developers \\
                \textbf{Pre-condition}: User has a valid Third-Party Developer SCEMAS account and is logged in. \\
                \textbf{Main Success Scenario}
                \begin{quote}
                    \begin{enumerate}[1.]
...
{\bf Global Scenario:}
        \begin{quote}
            \textbf{Pre-condition}: User has a valid Public User or Third-Party Developer SCEMAS account and is logged in. \\
            \textbf{Main Success Scenario}
            \begin{quote}
                \begin{enumerate}[1.]
                    \item User selects ``Request Account Modification''.
...
\begin{enumerate}[{\bf BE9.}]
	\item Create Account \#9
		\begin{enumerate}[{\bf VP1.}]
			\item City Operators \#1\\
                \textbf{Pre-condition}: User does not have a SCEMAS account and is not logged in. \\
                \textbf{Main Success Scenario}
                \begin{quote}
                    \begin{enumerate}[1.]
                        \item User navigates to the SCEMAS portal
			...
			\item Administrators \#3\\
                \textbf{Pre-condition}: User has a registered Administrator SCEMAS account and is logged in. \\
                \textbf{Main Success Scenario}
                \begin{quote}
                    \begin{enumerate}[1.]
    ...
    {\bf Global Scenario:}
        \begin{quote}
            \textbf{Pre-condition}: The user does not have an existing SCEMAS account. Administrators and IT Support personnel must be logged into an authorized administrative account. \\
            \textbf{Main Success Scenario}
            \begin{quote}
                \begin{enumerate}[1.]
                    \item The requester (City Operator, Administrator, or IT Support) navigates to the SCEMAS portal or administrative dashboard.
...
\begin{enumerate}[{\bf BE10.}]
    \item Login
        \begin{enumerate}[{\bf VP1.}]
            \item City Operators \#1\\
                \textbf{Pre-condition}: User has a valid City Operator SCEMAS account.\\
                \textbf{Main Success Scenario}
                \begin{quote}
                    \begin{enumerate}[1.]
                        \item User navigates to the SCEMAS login page
            ...
            \item Administrators \#3\\
                \textbf{Pre-condition}: User has a valid Administrator SCEMAS account.\\
                \textbf{Main Success Scenario}
                \begin{quote}
                    \begin{enumerate}[1.]
            ...
            \item IT Support \#6\\
                \textbf{Pre-condition}: IT Support has a valid Administrator SCEMAS account.\\
                \textbf{Main Success Scenario}
                \begin{quote}
                    \begin{enumerate}[1.]
    ...
    {\bf Global Scenario:}
        \begin{quote}
            \textbf{Pre-condition}: User must have a valid SCEMAS account for their respective role (City Operator, Administrator, or IT Support). User is not currently logged into the system.\\
            \textbf{Main Success Scenario}
            \begin{quote}
                \begin{enumerate}[1.]
                    \item The user (City Operator, Administrator, or IT Support) navigates to the SCEMAS login page.
...
\begin{enumerate}[{UH-EOU}1. ]
	...
	\textbf{Rationale:} If users encounter a problem they should be able to receive a response from the SCEMAS team to address their issue and implement fixes.
...
\begin{enumerate}[{SR-AC}1. ]
    ...
    \item The system must enforce Role-Base Access Control (\textbf{RBAC}) to distinguish between the different user groups, such as administrator, city operator, and read-only public users. \\
...
\begin{enumerate}[{SR-P}1. ]
    ...
    \textbf{Rationale}: Protects individual privacy, and ensures compliance with PIPEDA (Personal Information Protection and Electronic Documents Act) regulations \cite{pipeda}.
...
\begin{enumerate}[{LR-COMP}1. ]
    ...
    \textbf{Rationale}: This is PIPEDA Fair Information Principle 2 - Identifying Purposes \cite{pipedaAll}.

    \item The system shall obtain the consent of users for the collection, use, or disclosure of their personal information. \\
    \textbf{Rationale}: This is PIPEDA Fair Information Principle 3 - Consent \cite{pipedaAll}.

    \item The system shall limit any collection of personal information to what is necessary for the stated purposes. \\
    \textbf{Rationale}: This is PIPEDA Fair Information Principle 4 - Limiting Collection \cite{pipedaAll}.
    ...
    \textbf{Rationale}: This is PIPEDA Fair Information Principle 5 - Limiting Use, Disclosure, and Retention \cite{pipedaAll}.
    ...
    \textbf{Rationale}: This is PIPEDA Fair Information Principle 7 - Safeguards \cite{pipedaAll}.
\end{enumerate}
% End SubSubSection
...
\begin{itemize}
    ...
    \item Designed 3 Use Case Diagram. Revised after rest of the group reviewed it.
    \item 4 Highlights of Functional Requirements:
    \begin{itemize}
