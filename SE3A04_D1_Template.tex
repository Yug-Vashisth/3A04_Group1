...
\label{sub:purpose}
% Begin SubSection
This document is used to establish the requirements, performance, and intended behaviour/uses of the Smart City Environmental Monitoring and Alert System (\textbf{SCEMAS}).
...
\begin{itemize}
    ...
    \item \textbf{Technical Expertise}: Advanced technical skills are required for system administrators. They should be familiar with configurable rule-based systems, authentication methods, role-based access control (\textbf{RBAC}) models, and audit logging.
\end{itemize}
...
\begin{enumerate}[{\bf BE7.}]
    \item Request Access to Public API
        \begin{enumerate}[{\bf VP1.}]
            ...
            \item Administrators \\
                \textbf{Pre-condition}: User has a registered Administrator SCHEMAS account and is logged in viewing admin dashboard.\\
                \textbf{Main Success Scenario}
                \begin{quote}
                    \begin{description}
...
\begin{enumerate}[{SR-P}1. ]
    ...
    \textbf{Rationale}: Protects individual privacy, and ensures compliance with PIPEDA regulations \cite{pipeda}.
...
\begin{itemize}
    ...
    \item Wrote the Origial BE5 (now revised by and combined with other BE)
