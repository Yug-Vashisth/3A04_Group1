...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{./assets/d2_arch.drawio.png}
...
\begin{itemize}
    \item Engaged in discussion of choice of architectures and subsystems.
    \item 3.1:
	\begin{itemize}
		\item Identification and justification of the choice of overall architecture.
		\item Consideration and elimination of design alternatives.
	...
	\end{itemize}
    \item Formatting fixes to CRC cards.
