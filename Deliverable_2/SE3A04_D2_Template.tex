...
\noindent The hybrid architecture establishes a system with strong modularity, high cohesion in each interactive agent, and low coupling across subsystem boundaries. Thus, the resulting architecture balances simplicity, reliability, and extensibility. The overarching architectural groupings are summarized in Table~\ref{tab:arch-overview}, where each represent the architectural styles that structure SCEMAS at a high level.

\begin{table}[H]
    \centering
    \caption{Architectural Groupings in SCEMAS}
    ...
    \hline
        ...
        & Handle system interactions, presentation behaviour, and local control logic across dashboards, alert interfaces, and account management views 
        & PAC \\
    \hline
        Data-Centered Components 
        & Store and manage centralized system data including sensor telemetry, alert rules and histories, administrative data, and account information 
        & Repository \\
    \hline
    \end{tabular}
\end{table}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{./assets/structural_diagram.png}
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{7.5cm}|p{7.5cm}|}
    \hline 
      \multicolumn{2}{|l|}{\textbf{Class Name: Main Dashboard (Boundary)}} \\
    \hline
    \textbf{Responsibility:} & \textbf{Collaborators:} \\
    \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{7.5cm}|p{7.5cm}|}
    \hline 
      \multicolumn{2}{|l|}{\textbf{Class Name: API Documentation (Boundary)}} \\
    \hline
    \textbf{Responsibility:} & \textbf{Collaborators:} \\
    \hline
        Knows API Controller \newline
...
\begin{table}[H]
    \centering
    \caption{CRC Card for API Database Entity}
    \vspace{1mm}
    \begin{tabular}{|p{7.5cm}|p{7.5cm}|}
    \hline 
      \multicolumn{2}{|l|}{\textbf{Class Name: API Database (Entity)}} \\
    \hline
    \textbf{Responsibility:} & \textbf{Collaborators:} \\
    \hline
        Knows API Controller \newline
...
\begin{table}[H]
    \centering
    \caption{CRC Card for Admin Database Entity}
    \vspace{1mm}
    \begin{tabular}{|p{7.5cm}|p{7.5cm}|}
    \hline 
      \multicolumn{2}{|l|}{\textbf{Class Name: Admin Database (Entity)}} \\
    \hline
    \textbf{Responsibility:} & \textbf{Collaborators:} \\
    \hline
        Knows Admin Dashboard Controller & Admin Dashboard Controller \\
...
\begin{table}[H]
    ...
    \hline
        ...
        Knows District Dashboard Controller \newline & District Dashboard Controller \\
    \hline
    \end{tabular}
\end{table}
\begin{table}[H]
    ...
    \begin{tabular}{|p{7.5cm}|p{7.5cm}|}
    \hline 
      \multicolumn{2}{|l|}{\textbf{Class Name: City Dashboard (Boundary)}} \\
    \hline
    \textbf{Responsibility:} & \textbf{Collaborators:} \\
    \hline
...
\begin{table}[H]
    \centering
    \caption{CRC Card for Air Quality Database Entity}
    \vspace{1mm}
    \begin{tabular}{|p{7.5cm}|p{7.5cm}|}
    \hline 
...
\begin{table}[H]
    \centering
    \caption{CRC Card for Soil Quality Database Entity}
    \vspace{1mm}
    \begin{tabular}{|p{7.5cm}|p{7.5cm}|}
    \hline 
...
\begin{table}[H]
    \centering
    \caption{CRC Card for Temperature Database Entity}
    \vspace{1mm}
    \begin{tabular}{|p{7.5cm}|p{7.5cm}|}
    \hline 
...
\begin{table}[H]
    \centering
    \caption{CRC Card for Forest Health Database Entity}
    \vspace{1mm}
    \begin{tabular}{|p{7.5cm}|p{7.5cm}|}
    \hline 
...
\begin{itemize}
    \item Section 3:
	\begin{itemize}
        \item Engaged in discussions for choices of architectures and subsystems.
		\item Identification and justification of the choice of overall architecture (3.1).
		\item Consideration and elimination of design alternatives (3.1).
		\item Design structural architecture diagram (3.1).
	\end{itemize}
	\item Section 4:
	\begin{itemize}
		\item Account Management Controller (CRC Card)
		\item Create Account (CRC Card)
		\item Modify Account (CRC Card)
		\item Login (CRC Card)
		\item Account Settings (CRC Card)
		\item View Account (CRC Card)
		\item Account Database (CRC Card)
        \item Formatting fixes for CRC cards.
	\end{itemize}
