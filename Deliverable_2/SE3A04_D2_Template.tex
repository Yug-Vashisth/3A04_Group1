...
\begin{itemize}
    ...
    \begin{table}[H]
		\centering
        \caption{CRC Card for Removing an Alert Rule Violation}
		\begin{tabular}{|p{5cm}|p{5cm}|}
		\hline 
    ...
    \begin{table}[H]
		\centering
        \caption{CRC Card for Confirming an Alert Violation}
		\begin{tabular}{|p{5cm}|p{5cm}|}
		\hline 
		 \multicolumn{2}{|l|}{\textbf{Class Name: Confirm Alert Violated (Boundary)}} \\
		\hline
		\textbf{Responsibility:} & \textbf{Collaborators:} \\
		\hline
		\vspace{1in} & \\
