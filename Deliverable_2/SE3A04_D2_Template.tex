...
The PAC architecture was selected, as it separates an interactive system into a hierarchy of cooperating agents, each with its own presentation logic, abstraction 
...
Within the main system controller, several high-level architectural groupings are defined as summarized in Table~\ref{tab:arch-overview}. These groupings reflect the interaction-oriented agents and the centralized repositories that support them.
